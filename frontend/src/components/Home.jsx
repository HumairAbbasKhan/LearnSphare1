  ...
  return (
    <div className="bg-gradient-to-r from-black to-blue-950 min-h-screen text-white">
      ...
      <div className="flex flex-col items-center justify-center text-center px-6">
        <h1 className="text-4xl font-bold text-orange-500 mt-4 mb-3">
          LearnSphere
        </h1>
        <h2 className="text-lg max-w-2xl leading-relaxed">
            ...
            {courses.map((course) => (
              <div key={course._id} className="p-1">
                <div className="rounded-lg  p-2 text-center">
                  <div className="h-24 flex justify-center items-center overflow-hidden hover:scale-110 transition">
                    <img
                      src={course.image.url}
                      alt={course.title}
                      className="w-4/5 h-4/7 object-cover rounded-xl"
                    />
                  </div>
